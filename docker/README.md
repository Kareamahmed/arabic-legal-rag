...
This directory contains the Docker setup for the RAG application, including all necessary services for development and monitoring.
...
```bash
docker compose up -d fastapi  pgvector 
```
...
docker compose up fastapi  prometheus grafana  --build -d
```
...
1. Log into Grafana at http://localhost:3000 (default credentials: kemo/kemo)
2. Add Prometheus as a data source (URL: http://prometheus:9090)
3. Import dashboards for FastAPI, PostgreSQL
